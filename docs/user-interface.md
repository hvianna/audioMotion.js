...
You can use the keyboard shortcuts below to control the player and change some settings without leaving fullscreen mode:
...
+ **NO BG** when active, sets a black background for the analyzer, instead of the color defined by each gradient (may improve contrast)
