...
<sub>Note: on Firefox you still can load local playlists and music files, if they're stored <u>*inside audioMotion's folder*</u> (tested up to Firefox version 66).</sub>
...
The underlined character in the switch indicates its keyboard shortcut, when available.
